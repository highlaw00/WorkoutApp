...
//
//    private fun showList(list: ArrayList<Exercise>, binding: FragmentAddListBinding) {
...
//
//        // adapter 연결
//        binding.rvMainWorkoutList.adapter = ExerciseListAdapter(list)
